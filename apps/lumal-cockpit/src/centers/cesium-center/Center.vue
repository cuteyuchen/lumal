...
.cesium-center__state {
  ...
  display: grid;
  place-items: center;
  background: color-mix(in srgb, var(--lumal-cockpit-map-mask), transparent 16%);
...
.cesium-center__state button {
  min-width: 88px;
  min-height: 44px;
  border: 1px solid var(--lumal-cockpit-accent);
  border-radius: var(--lumal-cockpit-radius);
  background: var(--lumal-cockpit-floating-bg);
