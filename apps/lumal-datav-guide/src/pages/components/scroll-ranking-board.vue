...
<template>
  <LumalScrollRankingBoard :items="items" unit="次" :visible-rows="4" style="height: 240px" />
<\/template>`

const configCode = `<LumalScrollRankingBoard
  :config="{
    data: [
      { name: '数据中心 A', value: 9820 },
      { name: '数据中心 B', value: 8610 },
...
<template>
  ...
  >
    ...
    <DemoBlock
      ...
      :min-height="280"
    >
      <LumalScrollRankingBoard :config="config" style="height: 240px" />
    </DemoBlock>
