...
<template>
  <LumalScrollBoard :config="config" style="height: 240px" />
<\/template>`

const modernCode = `<LumalScrollBoard
  :rows="rows"
  :columns="[
    { key: 'area', label: '区域' },
...
<template>
  ...
  >
    ...
    >
      <LumalScrollBoard :config="playConfig" style="height: 240px; width: 100%;" />
    </Playground>
