...
<template>
  ...
  >
    ...
    <div
      v-else-if="variant === 4"
      class="lumal-decoration__line-reveal"
      :class="[
        reverse ? 'lumal-decoration__line-reveal--horizontal' : 'lumal-decoration__line-reveal--vertical',
    ...
    <div v-else-if="variant === 7" class="lumal-decoration__chevrons">
      ...
      <div class="lumal-decoration__content lumal-decoration__content--inline">
        <slot />
      </div>
      <svg aria-hidden="true" focusable="false" height="20" viewBox="0 0 21 20" width="21">
    ...
    >
      ...
      <circle class="lumal-decoration__ring" cx="50" cy="50" fill="transparent" r="45" stroke-dasharray="80,100,30,100" :stroke="resolvedColors[1]" stroke-width="10">
      ...
      <circle class="lumal-decoration__ring" cx="50" cy="50" fill="transparent" r="45" stroke-dasharray="50,66,100,66" :stroke="resolvedColors[0]" stroke-width="6">
        <animateTransform v-if="animationEnabled" attributeName="transform" :dur="smilDuration(3)" repeatCount="indefinite" type="rotate" :values="reverse ? '0 50 50;360 50 50' : '0 50 50;-360 50 50'" />
      </circle>
      <circle class="lumal-decoration__ring" cx="50" cy="50" fill="transparent" r="38" stroke-dasharray="5,1" :stroke="fadeColor(resolvedColors[1], 30)" stroke-width="1" />
      <use
      ...
      <circle class="lumal-decoration__ring" cx="50" cy="50" fill="transparent" r="26" stroke-dasharray="5,1" :stroke="fadeColor(resolvedColors[1], 30)" stroke-width="1" />
    </svg>
    ...
    >
      ...
      <polyline class="lumal-decoration__segment" fill="transparent" :points="`${xPosition(5)},${height / 2} ${xPosition(width * 0.2 - 3)},${height / 2}`" :stroke="resolvedColors[0]" :stroke-dasharray="`0,${width * 0.2}`" stroke-width="2">
      ...
      <polyline class="lumal-decoration__segment" fill="transparent" :points="`${xPosition(width * 0.2 + 3)},${height / 2} ${xPosition(width * 0.8 - 3)},${height / 2}`" :stroke="resolvedColors[0]" :stroke-dasharray="`0,${width * 0.6}`" stroke-width="2">
      ...
      <polyline class="lumal-decoration__segment" fill="transparent" :points="`${xPosition(width * 0.8 + 3)},${height / 2} ${xPosition(width - 5)},${height / 2}`" :stroke="resolvedColors[0]" :stroke-dasharray="`0,${width * 0.2}`" stroke-width="2">
    ...
    <div
      v-if="variant !== 7"
      class="lumal-decoration__content"
      :class="{ 'lumal-decoration__content--centered': variant === 9 || variant === 11 || variant === 12 }"
    >
      <slot />
    </div>
  </div>
